...
# Dataset directories.
DATASET_DIR = {
    BEAUTY: '/content/drive/My Drive/PGPR_conv2d/data/Amazon_Beauty',
    CELL: '/content/drive/My Drive/PGPR_conv2d/data/Amazon_Cellphones',
    CLOTH: '/content/drive/My Drive/PGPR_conv2d/data/Amazon_Clothing',
    CD: '/content/drive/My Drive/PGPR_conv2d/data/Amazon_CDs',
}

# Model result directories.
TMP_DIR = {
    BEAUTY: '/content/drive/My Drive/PGPR_conv2d/tmp/Amazon_Beauty',
    CELL: '/content/drive/My Drive/PGPR_conv2d/tmp/Amazon_Cellphones',
    CLOTH: '/content/drive/My Drive/PGPR_conv2d/tmp/Amazon_Clothing',
    CD: '/content/drive/My Drive/PGPR_conv2d/tmp/Amazon_CDs',
}
